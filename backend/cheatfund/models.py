...
class ChitAgreementDetails(models.Model):
    ...
    scheduled_auction_day = models.IntegerField()
    scheduled_last_date_of_payment = models.IntegerField(null=True)
    ...
    prize_collection = models.CharField(max_length=60, null=True)
...
class BidAgreementDetails(models.Model):
    ...
    chequeNo = models.CharField(max_length=100, null=True)
    cheqDate = models.DateField(null=True)
    cheqBank = models.CharField(max_length=200, null=True)
