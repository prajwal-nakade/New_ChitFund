    ...
    <>
      <div className="max-w-7xl mx-auto min-h-screen flex items-center justify-center">
        <form
          ...
          className=" flex flex-col gap-4 w-120 bg-white px-5 py-5 shadow-lg rounded-md border border-neutral-300"
        >
          ...
          <div className="flex flex-col items-start justify-start gap-2 w-full relative">
            ...
            <button
              type="button"
              className="absolute right-3 text-neutral-500 top-11"
          ...
          {loading ? (
            <button className="bg-[#06c] mt-4 text-white px-4 py-2 rounded-md flex items-center justify-center gap-2">
