      ...
      <div className="max-w-4xl mx-auto bg-white border border-black px-8 py-6 text-[14px] leading-5.5 text-justify print-page">
        ...
        <div className="mt-4">
          <div className="flex ">
            ...
            <input
              className="border-b border-black w-64 outline-none bg-transparent mx-2 flex-1"
              disabled
          ...
          <div className="flex flex-col mt-2">
            <div className="flex">
              <p>
                04) (Here in after called the Payee)
        ...
        <div className="mt-2">
          <p>
            ...
            <input
              className="border-b border-black w-50 outline-none bg-transparent mx-2 flex-1 text-center"
              value={chit?.ChitValue}
            />
            Duration{" "}
            <input
              className="border-b border-black w-30 outline-none bg-transparent mx-2 flex-1 text-center"
              value={bidAgreement?.totalMemberofGroup}
            />{" "}
            months, having{" "}
            <input
              className="border-b border-black w-30 outline-none bg-transparent mx-2 flex-1 text-center"
            ...
            Subscribers Rs.{" "}
            <input
              className="border-b border-black w-64 outline-none bg-transparent mx-2 flex-1 text-center"
              value={chitAgreement?.installment_amount}
            />
            ...
            <input
              className="border-b border-black w-64 outline-none bg-transparent mx-2 flex-1 text-center"
              value={dayjs(chitAgreement?.date_of_commencement).format(
                "DD MMM YYYY",
              )}
            />
        ...
        <div className="mt-2">
          <p>
            ...
            <input
              className="border-b border-black w-50 outline-none bg-transparent mx-2 flex-1 text-center uppercase"
            ...
            <input
              className="border-b border-black w-64 outline-none bg-transparent mx-2 flex-1 text-center"
              value={`${numberToWords(chit?.ChitValue)} Rupees`}
            />
            ) which was auctioned / draw on{" "}
            <span>
              {dayjs(bidAgreement?.dateofAuction).format("DD/MM/YYYY")}
            </span>{" "}
            and the amount including the Foreman's Commission viz Rs.{" "}
            <input
              className="border-b border-black w-64 outline-none bg-transparent mx-2 flex-1 text-center"
              value={bidAgreement?.foremanCommision}
            />{" "}
        ...
        <div className="mt-2">
          <p>
            ...
            <input className="border-b border-black w-50 outline-none bg-transparent mx-2 flex-1 text-center" />{" "}
            (Rupees{" "}
            <input className="border-b border-black w-50 outline-none bg-transparent mx-2 flex-1 text-center" />{" "}
