      ...
      <div className="container max-w-7xl mx-auto">
        <div className=" leading-5" ref={ref}>
            ...
            <div className="border-r border-l border-b w-full schedule-border">
                    ...
                    <tr className="h-30">
                      <td className="border-t  border-black p-2 align-top">
                        <div className="w-full h-20 resize-none outline-none text-start font-medium ps-3 flex flex-col items-start justify-start gap-2">
                          ...
                          <span className="flex gap-4 w-full text-xs"><strong className="w-39 name">Fullname:</strong>{`${user.firstname} ${user.middlename} ${user.lastname}`}</span>
              ...
              <div className="flex w-full px-4 py-2 schedule">
                <div className="flex items-start w-full text-sm">
                  ...
                  <span className="border-b w-50 px-3 py-1 text-center outline-none font-medium">{formatTime(chitAgreementData.scheduled_auction_time)}</span>
                </div>
          ...
          <div className="mx-4 text-sm mt-3">
            ...
            <div className="flex ms-4 py-2 gap-3">
              <div className="flex">
          ...
          <div className="mx-5 text-justify text-sm">
            ...
            <p className="pl-4">
              ...
              <input
                type="text"
                className="border-b text-center outline-none font-medium w-20"
                value={getOrdinal(chitAgreementData.auction_frequency)}
              />
              day of every month/day/week between{" "}
              <span
                className="border-b text-center outline-none font-medium">
                  {formatTime(chitAgreementData?.auction_session_start)}
              </span>{" "}
              and{" "}
              <span
                className="border-b text-center outline-none font-medium">
                  {formatTime(chitAgreementData?.auction_session_end)}
              </span>{" "}
            ...
            <p className="pl-4">
              ...
              <input
                ...
                value={chitAgreementData?.chit?.ByLawsNumber}
              />{" "}
            ...
            <p className="pl-4">
              ...
              216, Near Holkar Chowk, Satara Parisar, Chh. Sambhajinagar <span className="text-xs">({chitAgreementData.company_reg_number})</span>.
            </p>
