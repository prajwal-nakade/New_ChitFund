  ...
  return (
    <div className="max-w-4xl mx-auto bg-white border border-black px-8 py-6 text-[16px] leading-6 ">
      ...
      <div className="mt-4 text-justify">
        ...
        <input className="outline-none inline-block border-b border-black w-130 mx-2"></input>
        only )
      </div>

      <div className="mt-3">
        Repayable with interest at
        <input className="outline-none inline-block border-b border-black w-20 mx-2"></input>
      ...
      <div className="mt-4">
        ...
        <div className="mt-2">
          ...
          <input className="outline-none text-center inline-block border-b border-black w-20 mx-2" disabled value={chit.TicketNmber}></input>
          in
          <input className="outline-none inline-block border-b border-black w-32 mx-2 text-center" disabled value={chit.GroupCode}></input>
          series, in Monthly Installment of Rs.
          <input className="outline-none inline-block border-b border-black w-24 mx-2"></input>
        </div>

        <div className="mt-1">
          ( Rupees
          <input className="outline-none inline-block border-b border-black w-64 mx-2"></input>
          only ) for
          <input className="outline-none inline-block border-b border-black w-16 mx-2"></input>
          Months
          <input className="outline-none inline-block border-b border-black w-64 mx-2"></input>
        </div>
      </div>
      ...
      <div className="mt-10 space-y-15">
        ...
        <div className="flex justify-between items-end">
          <div className="w-[400px] flex flex-col items-center justify-center mx-auto">
            <div className="border-b border-black w-full text-center">{`${user.firstname} ${user.middlename} ${user.lastname}`}</div>
        ...
        <div className="flex justify-between items-end">
          <div className="w-[400px] flex flex-col items-center justify-center mx-auto">
            <div className="border-b border-black w-full text-center">{`${user.nominees[0].firstname} ${user.nominees[0].middlename} ${user.nominees[0].lastname}`}</div>
