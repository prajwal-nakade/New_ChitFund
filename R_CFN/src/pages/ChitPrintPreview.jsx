      ...
      <div className="print-container">
        <div ref={ref} className="p-6">
          ...
          <div className="mx-auto text-center mb-4">
            <div className="text-end text-xs pb-1 text-gray-600">
              <p>CIN NO.U64990MH2023PTC400938</p>
            </div>
            <div className="text-2xl font-bold border-b border-gray-800 mb-2 pb-1">
              <h1>KARDE KRISHNA CHITS PVT LTD</h1>
            </div>
          ...
          <div className="mb-4">
            <div className="flex justify-between mb-2 gap-4">
              ...
              <div className="flex items-center w-1/3">
                ...
                <div className="border-b border-gray-800 flex-1 text-center">
                  <span className="font-medium text-sm">{chitDetails.GroupCode}</span>
                </div>
              </div>
              ...
              <div className="flex items-center w-1/3">
                ...
                <div className="border-b border-gray-800 flex-1 text-center">
                  <span className="font-medium text-sm">{chitDetails.TicketNmber}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between">
              <div className="flex items-center w-1/3">
                ...
                <div className="border-b border-gray-800 flex-1 text-center">
                  <span className="font-medium text-sm">{chitDetails.ChitValue}</span>
                </div>
              </div>
              ...
              <div className="flex items-center w-1/3">
                ...
                <div className="border-b border-gray-800 flex-1 text-center">
                  <span className="font-medium text-sm">{chitDetails.branchName}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-4">
            <div className="w-full text-center py-1 bg-neutral-800 text-white mb-3">
              <h1 className="text-base font-bold">Full Name and Correspondence Address</h1>
            </div>
            ...
            <div className="flex justify-between mb-2">
              ...
              <div className="flex items-center w-1/3">
                ...
                <div className="border-b border-gray-800 flex-1 text-center">
                  <span className="font-medium text-sm">{dayjs(user.dob).format('DD-MM-YYYY')}</span>
                </div>
              </div>
            ...
            <div className="mb-2">
              <div className="flex items-center">
                <label className="w-40 text-sm font-medium">Permanent Address:</label>
                <div className="border-b border-gray-800 flex-1">
                  <span className="ml-1 font-medium text-sm">{user.permanent_address}</span>
                </div>
              </div>
            </div>
          ...
          {nominee && (
            <div className="mb-4">
              ...
              <div className="flex justify-between">
                <div className="flex items-center w-1/3">
                  <label className="w-28 text-sm font-medium">Relationship:</label>
                  <div className="border-b border-gray-800 flex-1 text-center">
                    <span className="font-medium text-sm">{nominee.relationship}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center w-1/3">
                  <label className="w-10 text-sm font-medium">DOB:</label>
                  <div className="border-b border-gray-800 flex-1 text-center">
                    <span className="font-medium text-sm">{dayjs(nominee.dob).format('DD-MM-YYYY')}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center w-1/3">
                  ...
                  <div className="border-b border-gray-800 flex-1 text-center">
                    <span className="font-medium text-sm">{nominee.mobile_no}</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="w-full border-t-2 py-2">
                ...
                <div className="  rounded-md  py-1">
                  <p className="text-sm tracking-wide text-neutral-600 text-justify">
                    ...
                    prized value at maximum discount of 40% of the chit value and here
                    by authorize the Foreman company to include my/our Name for the
                    draw for first{" "}
