...
import { LayoutDashboard, ChevronDown, ClipboardList, User, MapPin, GraduationCap, Handshake, Table2, BookOpenCheck } from "lucide-react";
        ...
        <div className="flex w-full items-center justify-start py-2 bg-[#E0F2FE] border-b border-[#1E3A8A]/20">
          <Link to={"/"} className="w-full">
            <div className="mx-auto my-[9.5px] flex justify-center items-center font-bold text-2xl w-full">
              ...
              <h1 className=" flex items-center text-blue-950"><span className="text-red-600">R</span>-Accounts</h1>
            </div>
          </Link>
        </div>
          ...
          <div className="flex flex-col gap-1 space-y-3 text-[#1E3A8A]">
            ...
            <div className="w-full">
              ...
              >
                ...
                Masters
                <ChevronDown size={16} className={`ml-auto transition-transform duration-200 ${isMasterOpen ? "rotate-180" : ""}`} />
              </button>
              {isMasterOpen && (
