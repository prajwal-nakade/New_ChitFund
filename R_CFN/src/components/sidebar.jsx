...
const Sidebar = () => {
  ...
  const Menus = [
    ...
    { title: "View Bid Agreement", icon: <BookOpenCheck size={16} />, path: "/viewauthenticationform" },
  ...
  return (
    <div className="flex min-h-screen w-60 overflow-hidden opacity-0 lg:opacity-100 bg-[#004f9e]  ">
